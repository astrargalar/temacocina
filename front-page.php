...
<?php while (have_posts()) : the_post(); ?>
    ...
    <div class="container-fluid imagenes-principales">
        ...
        <div class=" row imagen-inferior imagen">
            ...
            <div class="col-md-6 imagen-fondo" style="background-image:url(<?php echo get_post_meta(get_the_ID(), 'edc_homepage_imagen_superior_2', true); ?>)"></div><!-- col-md-6 bg-comida-->
        </div><!-- row imagen-->
